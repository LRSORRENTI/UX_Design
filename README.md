...
Methods: Conduct user interviews, surveys, 
ethnographic studies, and competitive analysis.
...
Launch the product and continue to gather user 
...
Empathize: Conduct user research to understand the user's needs and context.

Define: Synthesize research findings to define a clear and actionable problem statement.

Ideate: Generate a broad range of ideas and potential solutions.

Prototype: Develop low-fidelity prototypes to explore and test ideas.

Test: Test prototypes with users, gather feedback, and iterate on the design.
...
Isolated Efforts: UX work being done in isolation without integrating with the overall product 
development process.
